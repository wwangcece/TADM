...
def parse_args_rescale_testing(input_args=None):
    """
   ...
   """
    ...
    parser.add_argument(
        "--test_config", default="./configs/tadm_test.yaml", type=str
    )
    ...
    parser.add_argument(
        "--dfrm_net_path", type=str, default="assets/mm-realsr/dfrm.ckpt"
    )
    parser.add_argument(
        "--pretrained_path",
        type=str,
        default="experiments/diff-final-x16-resume/checkpoints/model_sr_22501.pkl",
    )
    parser.add_argument("--lora_rank_unet", default=48, type=int)

    parser.add_argument("--scale_factor", type=int, default=16, help="Scale factor for rescaling.")
    parser.add_argument("--padding_offset", type=int, default=32, help="padding offset.")

    parser.add_argument("--vae_decoder_tiled_size", type=int, default=1024)
    parser.add_argument("--vae_encoder_tiled_size", type=int, default=1024) 
    # parser.add_argument("--latent_tiled_size", type=int, default=96)
    # parser.add_argument("--latent_tiled_overlap", type=int, default=32)
    parser.add_argument("--latent_tiled_size", type=int, default=1024)
    parser.add_argument("--latent_tiled_overlap", type=int, default=1024)

    # training details
    parser.add_argument(
        "--output_dir", type=str, default="experiments/test-time/DIV2K"
    )
    parser.add_argument(
        "--save_ts",
        action="store_true",
        help="Whether or not to save timestep maps.",
    )
